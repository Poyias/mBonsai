...
g++ -O6 -Wall -fpermissive -std=c++11 -w -Wall  -Wextra  -DNDEBUG  -g -ffast-math -funroll-loops -msse4.2 -I/home/eshime/include -L/home/eshime/lib subLayer.o DArray.o mBonsaiHash.o data.o mBonsai.o main.cpp -o mBonsai -lsdsl -ldivsufsort -ldivsufsort64 -DSLEN=9 -DDARRAYSIZE=3 -DSLEN2=5 -DSAT=7
echo ready to run
 
./mBonsai 4242318 442 ../datasets/sortedAccidents.dat 0.8 .../datasets/sortedAccidents.dat  #756665 #9,3,5,7
